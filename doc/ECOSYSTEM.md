...
**Rating: A (93.2% weighted)** — 110 executed probes, 9 scored N/A.

Measured 2026-08-20T14:58:55Z on `aarch64-apple-darwin`, rustc 1.97.1 (8bab26f4f 2026-07-14). Rubric executed: 92%.

| Repo | Metric | Measured | Score | Probe |
|---|---|---|---:|---|
| `noyalib` | tests | 5627 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
...
| `noyalib` | audit_vulnerabilities | 0 advisories | 1.00 | `cargo audit --json | .vulnerabilities.count` |
...
| `noyalib` | dependency_closure | 12 unique runtime crates | 1.00 | `cargo tree -e normal --prefix none --no-dedupe | sort -u (budget 60)` |
...
| `noyalib` | crates_io_current | tree 0.0.25 / crates.io 0.0.25 | 1.00 | `crates.io/api/v1/crates/noyalib .max_stable_version` |
| `noyalib` | openssf_scorecard | 8/10 | 0.80 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib .score` |
...
| `noya-cli` | missing_docs_lint | 0/1 roots deny missing_docs | 0.00 | `grep for deny/warn(missing_docs) in crate roots` |
| `noya-cli` | readme_examples | no harness | n/a | `scripts/check-readme-examples.sh absent` |
| `noya-cli` | audit_vulnerabilities | 0 advisories | 1.00 | `cargo audit --json | .vulnerabilities.count` |
...
| `noya-cli` | dependency_closure | 130 unique runtime crates | 0.00 | `cargo tree -e normal --prefix none --no-dedupe | sort -u (budget 60)` |
| `noya-cli` | actions_sha_pinned | 34/34 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
| `noya-cli` | fuzz_targets | no fuzz/ dir | 0.00 | `find fuzz/fuzz_targets` |
...
| `noya-cli` | crates_io_current | tree 0.0.25 / crates.io 0.0.25 | 1.00 | `crates.io/api/v1/crates/noya-cli .max_stable_version` |
| `noya-cli` | openssf_scorecard | 6.5/10 | 0.65 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noya-cli .score` |
...
| `noyalib-lsp` | readme_examples | no harness | n/a | `scripts/check-readme-examples.sh absent` |
| `noyalib-lsp` | audit_vulnerabilities | 0 advisories | 1.00 | `cargo audit --json | .vulnerabilities.count` |
...
| `noyalib-lsp` | dependency_closure | 96 unique runtime crates | 0.40 | `cargo tree -e normal --prefix none --no-dedupe | sort -u (budget 60)` |
| `noyalib-lsp` | actions_sha_pinned | 34/34 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
| `noyalib-lsp` | fuzz_targets | no fuzz/ dir | 0.00 | `find fuzz/fuzz_targets` |
...
| `noyalib-lsp` | crates_io_current | tree 0.0.25 / crates.io 0.0.25 | 1.00 | `crates.io/api/v1/crates/noyalib-lsp .max_stable_version` |
| `noyalib-lsp` | openssf_scorecard | 6.5/10 | 0.65 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib-lsp .score` |
...
| `noyalib-mcp` | readme_examples | no harness | n/a | `scripts/check-readme-examples.sh absent` |
| `noyalib-mcp` | audit_vulnerabilities | 0 advisories | 1.00 | `cargo audit --json | .vulnerabilities.count` |
...
| `noyalib-mcp` | dependency_closure | 19 unique runtime crates | 1.00 | `cargo tree -e normal --prefix none --no-dedupe | sort -u (budget 60)` |
| `noyalib-mcp` | actions_sha_pinned | 51/51 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
| `noyalib-mcp` | fuzz_targets | no fuzz/ dir | 0.00 | `find fuzz/fuzz_targets` |
...
| `noyalib-mcp` | crates_io_current | tree 0.0.25 / crates.io 0.0.25 | 1.00 | `crates.io/api/v1/crates/noyalib-mcp .max_stable_version` |
| `noyalib-mcp` | openssf_scorecard | 6.4/10 | 0.64 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib-mcp .score` |
...
| `noyalib-wasm` | missing_docs_lint | 0/1 roots deny missing_docs | 0.00 | `grep for deny/warn(missing_docs) in crate roots` |
| `noyalib-wasm` | readme_examples | no harness | n/a | `scripts/check-readme-examples.sh absent` |
| `noyalib-wasm` | audit_vulnerabilities | 0 advisories | 1.00 | `cargo audit --json | .vulnerabilities.count` |
...
| `noyalib-wasm` | dependency_closure | 33 unique runtime crates | 1.00 | `cargo tree -e normal --prefix none --no-dedupe | sort -u (budget 60)` |
| `noyalib-wasm` | actions_sha_pinned | 42/42 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
| `noyalib-wasm` | fuzz_targets | no fuzz/ dir | 0.00 | `find fuzz/fuzz_targets` |
...
| `noyalib-wasm` | crates_io_current | tree 0.0.25 / crates.io 0.0.25 | 1.00 | `crates.io/api/v1/crates/noyalib-wasm .max_stable_version` |
| `noyalib-wasm` | openssf_scorecard | 6.4/10 | 0.64 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib-wasm .score` |
| `ecosystem` | version_lockstep | 4/4 pin =0.0.25 | 1.00 | `grep the noyalib pin in each satellite Cargo.toml (ADR-0005); all aligned` |
