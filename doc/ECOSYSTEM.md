...
Measured 2026-08-21T22:30:21Z on `aarch64-apple-darwin`, rustc 1.97.1 (8bab26f4f 2026-07-14). Rubric executed: 92%.

| Repo | Metric | Measured | Score | Probe |
|---|---|---|---:|---|
| `noyalib` | tests | 5739 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
