...
**Rating: A- (91.6% weighted)** — 110 executed probes, 9 scored N/A.

Measured 2026-08-21T15:05:23Z on `aarch64-apple-darwin`, rustc 1.97.1 (8bab26f4f 2026-07-14). Rubric executed: 92%.

| Repo | Metric | Measured | Score | Probe |
|---|---|---|---:|---|
| `noyalib` | tests | timeout after 3600s | 0.00 | `cargo test --workspace --locked --default-features (killed at ceiling)` |
...
| `noyalib` | crates_io_current | tree 0.0.27 / crates.io 0.0.27 | 1.00 | `crates.io/api/v1/crates/noyalib .max_stable_version` |
...
| `noya-cli` | crates_io_current | tree 0.0.27 / crates.io 0.0.27 | 1.00 | `crates.io/api/v1/crates/noya-cli .max_stable_version` |
...
| `noyalib-lsp` | crates_io_current | tree 0.0.27 / crates.io 0.0.27 | 1.00 | `crates.io/api/v1/crates/noyalib-lsp .max_stable_version` |
...
| `noyalib-mcp` | crates_io_current | tree 0.0.27 / crates.io 0.0.27 | 1.00 | `crates.io/api/v1/crates/noyalib-mcp .max_stable_version` |
...
| `noyalib-wasm` | crates_io_current | tree 0.0.27 / crates.io 0.0.27 | 1.00 | `crates.io/api/v1/crates/noyalib-wasm .max_stable_version` |
...
| `ecosystem` | version_lockstep | 4/4 pin =0.0.27 | 1.00 | `grep the noyalib pin in each satellite Cargo.toml (ADR-0005); all aligned` |
