...
**Rating: A (94.8% weighted)** — 130 executed probes, 12 scored N/A.

Measured 2026-09-18T13:28:05Z on `aarch64-apple-darwin`, rustc 1.98.0 (88d9e12ae 2026-08-18). Rubric executed: 92%.

| Repo | Metric | Measured | Score | Probe |
|---|---|---|---:|---|
| `noyalib` | tests | build failed (rc=101) | 0.00 | `cargo test --workspace --locked --default-features --no-run` |
| `noyalib` | spec_conformance | 406/406 cases | 1.00 | `cargo test -p noyalib --test yaml_compliance_report` |
| `noyalib` | clippy | 2 diagnostics (rc=101) | 0.00 | `cargo clippy --workspace --all-targets --locked --default-features -- -D warnings` |
...
| `noyalib` | reuse_compliance | non-compliant | 0.00 | `reuse lint (REUSE 3.3)` |
...
| `noyalib` | actions_sha_pinned | 147/147 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
...
| `noyalib` | crates_io_current | tree 0.0.45 / crates.io 0.0.44 | 0.00 | `crates.io/api/v1/crates/noyalib .max_stable_version` |
| `noyalib` | openssf_scorecard | 8.8/10 | 0.88 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib .score` |
| `noya-cli` | tests | 85 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
...
| `noya-cli` | crates_io_current | tree 0.0.44 / crates.io 0.0.44 | 1.00 | `crates.io/api/v1/crates/noya-cli .max_stable_version` |
| `noya-cli` | openssf_scorecard | 7.6/10 | 0.76 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noya-cli .score` |
| `noyalib-lsp` | tests | 64 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
...
| `noyalib-lsp` | crates_io_current | tree 0.0.44 / crates.io 0.0.44 | 1.00 | `crates.io/api/v1/crates/noyalib-lsp .max_stable_version` |
...
| `noyalib-mcp` | tests | 78 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
...
| `noyalib-mcp` | dependency_closure | 71 unique runtime crates (leaf, not scored) | n/a | `cargo tree -e normal --prefix none --no-dedupe \| sort -u — recorded, not scored: a leaf binary's tree is not inherited` |
...
| `noyalib-mcp` | crates_io_current | tree 0.0.44 / crates.io 0.0.44 | 1.00 | `crates.io/api/v1/crates/noyalib-mcp .max_stable_version` |
...
| `noyalib-wasm` | tests | 46 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
...
| `noyalib-wasm` | crates_io_current | tree 0.0.44 / crates.io 0.0.44 | 1.00 | `crates.io/api/v1/crates/noyalib-wasm .max_stable_version` |
...
| `noyalib-serde-yaml` | tests | 6 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
| `noyalib-serde-yaml` | clippy | 0 diagnostics (rc=0) | 1.00 | `cargo clippy --workspace --all-targets --locked --default-features -- -D warnings` |
...
| `noyalib-serde-yaml` | crates_io_current | tree 0.0.44 / crates.io 0.0.44 | 1.00 | `crates.io/api/v1/crates/noyalib-serde-yaml .max_stable_version` |
...
| `ecosystem` | version_lockstep | core 0.0.45 not tagged yet | n/a | `git tag -l v0.0.45 in noyalib (pending release; satellites pin only published versions)` |
