...
**Rating: A (94.3% weighted)** — 134 executed probes, 12 scored N/A.

Measured 2026-09-21T23:34:48Z on `aarch64-apple-darwin`, rustc 1.98.0 (88d9e12ae 2026-08-18). Rubric executed: 92%.
...
| `noya-cli` | crates_io_current | tree 0.0.47 / crates.io 0.0.47 | 1.00 | `crates.io/api/v1/crates/noya-cli .max_stable_version` |
...
| `noyalib-lsp` | crates_io_current | tree 0.0.47 / crates.io 0.0.47 | 1.00 | `crates.io/api/v1/crates/noyalib-lsp .max_stable_version` |
...
| `noyalib-mcp` | crates_io_current | tree 0.0.47 / crates.io 0.0.47 | 1.00 | `crates.io/api/v1/crates/noyalib-mcp .max_stable_version` |
...
| `noyalib-wasm` | crates_io_current | tree 0.0.47 / crates.io 0.0.47 | 1.00 | `crates.io/api/v1/crates/noyalib-wasm .max_stable_version` |
...
| `noyalib-serde-yaml` | crates_io_current | tree 0.0.47 / crates.io 0.0.47 | 1.00 | `crates.io/api/v1/crates/noyalib-serde-yaml .max_stable_version` |
