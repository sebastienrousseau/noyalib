...
**Rating: B+ (87.3% weighted)** — 134 executed probes, 12 scored N/A.

Measured 2026-09-21T14:39:25Z on `aarch64-apple-darwin`, rustc 1.98.0 (88d9e12ae 2026-08-18). Rubric executed: 92%.

| Repo | Metric | Measured | Score | Probe |
|---|---|---|---:|---|
| `noyalib` | tests | 6437 passed / 0 failed | 1.00 | `cargo test --workspace --locked` |
...
| `noyalib` | fuzz_targets | 15 libFuzzer targets | 1.00 | `find fuzz/fuzz_targets -name '*.rs' (floor 2)` |
...
| `noyalib` | crates_io_current | tree 0.0.47 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noyalib .max_stable_version` |
| `noyalib` | openssf_scorecard | 8.5/10 | 0.85 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib .score` |
...
| `noya-cli` | crates_io_current | tree 0.0.47 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noya-cli .max_stable_version` |
...
| `noyalib-lsp` | crates_io_current | tree 0.0.47 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noyalib-lsp .max_stable_version` |
...
| `noyalib-mcp` | tests | 65 passed / 0 failed | 1.00 | `cargo test --workspace --locked` |
...
| `noyalib-mcp` | crates_io_current | tree 0.0.47 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noyalib-mcp .max_stable_version` |
...
| `noyalib-wasm` | vet_audited | fail | 0.00 | `cargo vet --locked` |
...
| `noyalib-wasm` | crates_io_current | tree 0.0.47 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noyalib-wasm .max_stable_version` |
...
| `noyalib-serde-yaml` | deny_check | pass | 1.00 | `cargo deny check (advisories, bans, licenses, sources)` |
...
| `noyalib-serde-yaml` | crates_io_current | tree 0.0.47 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noyalib-serde-yaml .max_stable_version` |
...
| `ecosystem` | version_lockstep | core 0.0.47 not tagged yet | n/a | `git tag -l v0.0.47 in noyalib (pending release; satellites pin only published versions)` |
