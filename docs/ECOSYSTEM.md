...
**Rating: B (86.1% weighted)** — 134 executed probes, 12 scored N/A.

Measured 2026-09-22T15:57:06Z on `aarch64-apple-darwin`, rustc 1.98.0 (88d9e12ae 2026-08-18). Rubric executed: 92%.
...
| `noyalib` | crates_io_current | tree 0.0.52 / crates.io 0.0.51 | 0.00 | `crates.io/api/v1/crates/noyalib .max_stable_version` |
...
| `noya-cli` | crates_io_current | tree 0.0.52 / crates.io 0.0.51 | 0.00 | `crates.io/api/v1/crates/noya-cli .max_stable_version` |
...
| `noyalib-lsp` | clippy | 4 diagnostics (rc=101) | 0.00 | `cargo clippy --workspace --all-targets --locked -- -D warnings` |
...
| `noyalib-lsp` | crates_io_current | tree 0.0.52 / crates.io 0.0.51 | 0.00 | `crates.io/api/v1/crates/noyalib-lsp .max_stable_version` |
...
| `noyalib-mcp` | crates_io_current | tree 0.0.52 / crates.io 0.0.51 | 0.00 | `crates.io/api/v1/crates/noyalib-mcp .max_stable_version` |
...
| `noyalib-wasm` | crates_io_current | tree 0.0.52 / crates.io 0.0.51 | 0.00 | `crates.io/api/v1/crates/noyalib-wasm .max_stable_version` |
...
| `noyalib-serde-yaml` | readme_examples | broken | 0.00 | `scripts/check-readme-examples.sh` |
...
| `noyalib-serde-yaml` | crates_io_current | tree 0.0.52 / crates.io 0.0.51 | 0.00 | `crates.io/api/v1/crates/noyalib-serde-yaml .max_stable_version` |
...
| `ecosystem` | version_lockstep | core 0.0.52 not tagged yet | n/a | `git tag -l v0.0.52 in noyalib (pending release; satellites pin only published versions)` |
