...
**Rating: B+ (87.2% weighted)** — 133 executed probes, 13 scored N/A.

Measured 2026-09-20T13:56:29Z on `aarch64-apple-darwin`, rustc 1.98.0 (88d9e12ae 2026-08-18). Rubric executed: 91%.

| Repo | Metric | Measured | Score | Probe |
|---|---|---|---:|---|
| `noyalib` | tests | 6421 passed / 0 failed | 1.00 | `cargo test --workspace --locked` |
...
| `noyalib` | actions_sha_pinned | 151/151 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
...
| `noyalib` | crates_io_current | tree 0.0.46 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noyalib .max_stable_version` |
| `noyalib` | openssf_scorecard | 8.6/10 | 0.86 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib .score` |
...
| `noya-cli` | crates_io_current | tree 0.0.46 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noya-cli .max_stable_version` |
...
| `noyalib-lsp` | crates_io_current | tree 0.0.46 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noyalib-lsp .max_stable_version` |
...
| `noyalib-mcp` | crates_io_current | tree 0.0.46 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noyalib-mcp .max_stable_version` |
...
| `noyalib-wasm` | crates_io_current | tree 0.0.46 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noyalib-wasm .max_stable_version` |
...
| `noyalib-serde-yaml` | ci_main_green | unknown | n/a | `gh run list --branch main --limit 1 --json conclusion` |
| `noyalib-serde-yaml` | crates_io_current | tree 0.0.46 / crates.io 0.0.45 | 0.00 | `crates.io/api/v1/crates/noyalib-serde-yaml .max_stable_version` |
...
| `ecosystem` | version_lockstep | core 0.0.46 not tagged yet | n/a | `git tag -l v0.0.46 in noyalib (pending release; satellites pin only published versions)` |
