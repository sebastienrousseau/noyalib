...
**Rating: A+ (98.0% weighted)** — 131 executed probes, 11 scored N/A.

Measured 2026-09-19T11:22:12Z on `aarch64-apple-darwin`, rustc 1.98.0 (88d9e12ae 2026-08-18). Rubric executed: 92%.
...
| `noyalib` | crates_io_current | tree 0.0.45 / crates.io 0.0.45 | 1.00 | `crates.io/api/v1/crates/noyalib .max_stable_version` |
| `noyalib` | openssf_scorecard | 8.7/10 | 0.87 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib .score` |
...
| `noya-cli` | crates_io_current | tree 0.0.45 / crates.io 0.0.45 | 1.00 | `crates.io/api/v1/crates/noya-cli .max_stable_version` |
...
| `noyalib-lsp` | crates_io_current | tree 0.0.45 / crates.io 0.0.45 | 1.00 | `crates.io/api/v1/crates/noyalib-lsp .max_stable_version` |
...
| `noyalib-mcp` | tests | 78 passed / 0 failed | 1.00 | `cargo test --workspace --locked` |
...
| `noyalib-mcp` | crates_io_current | tree 0.0.45 / crates.io 0.0.45 | 1.00 | `crates.io/api/v1/crates/noyalib-mcp .max_stable_version` |
...
| `noyalib-wasm` | crates_io_current | tree 0.0.45 / crates.io 0.0.45 | 1.00 | `crates.io/api/v1/crates/noyalib-wasm .max_stable_version` |
...
| `noyalib-serde-yaml` | crates_io_current | tree 0.0.45 / crates.io 0.0.45 | 1.00 | `crates.io/api/v1/crates/noyalib-serde-yaml .max_stable_version` |
...
| `ecosystem` | version_lockstep | 5/5 pin =0.0.45 | 1.00 | `grep the noyalib pin in each satellite Cargo.toml (ADR-0005); all aligned` |
