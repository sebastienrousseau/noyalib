...
**Rating: A+ (97.9% weighted)** — 131 executed probes, 11 scored N/A.

Measured 2026-09-05T16:47:02Z on `aarch64-apple-darwin`, rustc 1.98.0 (88d9e12ae 2026-08-18). Rubric executed: 92%.

| Repo | Metric | Measured | Score | Probe |
|---|---|---|---:|---|
| `noyalib` | tests | 6074 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
...
| `noyalib` | actions_sha_pinned | 135/135 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
| `noyalib` | fuzz_targets | 12 libFuzzer targets | 1.00 | `find fuzz/fuzz_targets -name '*.rs' (floor 2)` |
...
| `noyalib` | crates_io_current | tree 0.0.33 / crates.io 0.0.33 | 1.00 | `crates.io/api/v1/crates/noyalib .max_stable_version` |
| `noyalib` | openssf_scorecard | 8.3/10 | 0.83 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib .score` |
...
| `noya-cli` | actions_sha_pinned | 61/61 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
...
| `noya-cli` | crates_io_current | tree 0.0.33 / crates.io 0.0.33 | 1.00 | `crates.io/api/v1/crates/noya-cli .max_stable_version` |
| `noya-cli` | openssf_scorecard | 7.5/10 | 0.75 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noya-cli .score` |
...
| `noyalib-lsp` | actions_sha_pinned | 45/45 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
...
| `noyalib-lsp` | crates_io_current | tree 0.0.33 / crates.io 0.0.33 | 1.00 | `crates.io/api/v1/crates/noyalib-lsp .max_stable_version` |
| `noyalib-lsp` | openssf_scorecard | 7.5/10 | 0.75 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib-lsp .score` |
| `noyalib-mcp` | tests | 69 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
...
| `noyalib-mcp` | actions_sha_pinned | 62/62 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
...
| `noyalib-mcp` | crates_io_current | tree 0.0.33 / crates.io 0.0.33 | 1.00 | `crates.io/api/v1/crates/noyalib-mcp .max_stable_version` |
| `noyalib-mcp` | openssf_scorecard | 7.4/10 | 0.74 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib-mcp .score` |
| `noyalib-wasm` | tests | 43 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
...
| `noyalib-wasm` | actions_sha_pinned | 53/53 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
...
| `noyalib-wasm` | crates_io_current | tree 0.0.33 / crates.io 0.0.33 | 1.00 | `crates.io/api/v1/crates/noyalib-wasm .max_stable_version` |
| `noyalib-wasm` | openssf_scorecard | 7.4/10 | 0.74 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib-wasm .score` |
| `noyalib-serde-yaml` | tests | 4 passed / 0 failed | 1.00 | `cargo test --workspace --locked --default-features` |
...
| `noyalib-serde-yaml` | actions_sha_pinned | 44/44 external uses pinned | 1.00 | `grep 'uses:.*@<40-hex>' .github/workflows` |
...
| `noyalib-serde-yaml` | crates_io_current | tree 0.0.33 / crates.io 0.0.33 | 1.00 | `crates.io/api/v1/crates/noyalib-serde-yaml .max_stable_version` |
| `noyalib-serde-yaml` | openssf_scorecard | 7.2/10 | 0.72 | `api.securityscorecards.dev/projects/github.com/sebastienrousseau/noyalib-serde-yaml .score` |
| `ecosystem` | version_lockstep | 5/5 pin =0.0.33 | 1.00 | `grep the noyalib pin in each satellite Cargo.toml (ADR-0005); all aligned` |
