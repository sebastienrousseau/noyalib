...
```toml
[dependencies]
noyalib-wasm = "0.0.50"   # crates.io; the repo does not matter to Cargo
noyalib-mcp  = "0.0.50"
```
...
cosign verify \
    ...
    ghcr.io/sebastienrousseau/noyalib-mcp:0.0.50
```
...
```toml
[dependencies]
noyalib-wasm = "=0.0.50"    # exact-match pins recommended
noyalib-mcp  = "=0.0.50"
```
...
```toml
[dependencies]
noyalib-wasm = { git = "https://github.com/sebastienrousseau/noyalib-wasm", tag = "v0.0.50" }
noyalib-mcp  = { git = "https://github.com/sebastienrousseau/noyalib-mcp",  tag = "v0.0.50" }
```
...
git subtree add --prefix=vendor/noyalib-wasm \
    https://github.com/sebastienrousseau/noyalib-wasm v0.0.50 --squash
```
