...
[ADR-0005](adr/0005-workspace-split.md). It's aimed at:
...
```toml
[dependencies]
noyalib-wasm = "0.0.52"   # crates.io; the repo does not matter to Cargo
noyalib-mcp  = "0.0.52"
```
...
cosign verify \
    ...
    ghcr.io/sebastienrousseau/noyalib-mcp:0.0.52
```
...
```toml
[dependencies]
noyalib-wasm = "=0.0.52"    # exact-match pins recommended
noyalib-mcp  = "=0.0.52"
```
...
```toml
[dependencies]
noyalib-wasm = { git = "https://github.com/sebastienrousseau/noyalib-wasm", tag = "v0.0.52" }
noyalib-mcp  = { git = "https://github.com/sebastienrousseau/noyalib-mcp",  tag = "v0.0.52" }
```
...
git subtree add --prefix=vendor/noyalib-wasm \
    https://github.com/sebastienrousseau/noyalib-wasm v0.0.52 --squash
```
...
review, the [ADR-0005 rollback recipe](adr/0005-workspace-split.md#rollback-recipe)
